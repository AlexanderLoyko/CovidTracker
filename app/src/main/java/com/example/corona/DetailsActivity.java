...
import com.example.corona.AffectedCountries;
...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Статистика по "+ AffectedCountries.countryModelList.get(positionCountry).getCountry());
